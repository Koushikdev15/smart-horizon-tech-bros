...
const rejected = mockBatches.filter(b => b.status === 'Rejected' && b.currentStage === 'Processing & Laboratory');
...
export default function RejectedBatches() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <PageHeader title="Rejected Batches" description="Batches that failed quality checks during processing or laboratory testing" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <StatsCard title="Rejection Rate" value="4.2%" icon={XCircle} iconColor="text-red-600" iconBg="bg-red-50 dark:bg-red-950/40" />
      </div>
