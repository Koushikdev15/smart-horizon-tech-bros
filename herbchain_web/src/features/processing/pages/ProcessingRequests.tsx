...
export default function ProcessingRequests() {
  const [batches] = useState<Batch[]>(mockBatches.filter(b => b.status === 'Processing' || b.status === 'Rejected'));
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {batch.aiSummary && (
                    <div className="mt-2 p-2 rounded-lg bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800">
                      <p className="text-xs text-emerald-700 dark:text-emerald-400 font-medium flex items-center gap-1"><Sparkles className="w-3 h-3" /> AI Summary</p>
