...
import { History as HistoryIcon, Leaf, MapPin, Package, QrCode } from 'lucide-react';
import type { Batch } from '../../../types';

const history = mockBatches.filter(b => b.timeline.find(t => t.stage === 'Manufacturing')?.status === 'Completed');
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <StatsCard title="Avg Quality Grade" value="A" icon={HistoryIcon} iconColor="text-emerald-600" iconBg="bg-emerald-50 dark:bg-emerald-950/40" />
      </div>
