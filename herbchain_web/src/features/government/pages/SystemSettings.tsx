  ...
  return (
    <div className="flex items-center justify-between py-2.5 border-b border-border/60 last:border-0">
      ...
      <button
        ...
        className={`relative w-10 h-5.5 rounded-full transition-colors shrink-0 ${checked ? 'bg-emerald-600' : 'bg-gray-300 dark:bg-gray-700'}`}
      >
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                <Button onClick={() => save('General')} className="bg-emerald-600 hover:bg-emerald-700 text-white">
        ...
        <TabsContent value="notifications" className="mt-4">
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-4">
                <Button onClick={() => save('Notification')} className="bg-emerald-600 hover:bg-emerald-700 text-white">
                  <Save className="w-4 h-4 mr-1.5" /> Save Changes
                </Button>
              </div>
            </CardContent>
        ...
        <TabsContent value="security" className="mt-4">
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-4">
                <Button onClick={() => save('Security')} className="bg-emerald-600 hover:bg-emerald-700 text-white">
                  <Save className="w-4 h-4 mr-1.5" /> Save Changes
                </Button>
              </div>
            </CardContent>
        ...
        <TabsContent value="blockchain" className="mt-4">
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-4">
                <Button onClick={() => save('Blockchain')} className="bg-emerald-600 hover:bg-emerald-700 text-white">
                  <Save className="w-4 h-4 mr-1.5" /> Save Changes
                </Button>
              </div>
            </CardContent>
