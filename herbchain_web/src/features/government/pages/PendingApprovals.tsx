                    ...
                    <TableRow key={m.id} className="table-row-hover">
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-950/50 flex items-center justify-center text-xs font-bold text-emerald-700">
                            {m.name.charAt(0)}
                          </div>
                          <div>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-1.5">
                          ...
                          <Button size="sm" onClick={() => handleAction(m.id, 'Active')} className="h-7 px-2 bg-emerald-600 hover:bg-emerald-700 text-white">
        ...
        <Dialog open onOpenChange={() => setSelected(null)}>
          <DialogContent className="max-w-lg">
            ...
            <div className="flex gap-2 mt-4">
              <Button onClick={() => handleAction(selected.id, 'Active')} className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white">
