            ...
            <div className="space-y-3 text-sm">
              ...
              {selected.status !== 'Resolved' && selected.status !== 'Closed' && (
                <div className="space-y-1.5">
                  ...
                  />
                  <Button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white" onClick={() => handleResolve(selected.id)} disabled={!resolution}>
              ...
              {selected.resolution && (
                <div className="p-3 rounded-lg bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800">
                  <p className="text-xs text-emerald-700 dark:text-emerald-400 font-medium mb-1">Resolution</p>
