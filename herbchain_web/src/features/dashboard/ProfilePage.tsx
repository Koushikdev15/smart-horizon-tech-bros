...
const roleColors: Record<UserRole, string> = {
  ...
  'Collection Center': 'text-emerald-600',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="text-center">
          <CardContent className="pt-8 pb-6">
            <div className="w-20 h-20 rounded-full bg-emerald-100 dark:bg-emerald-950/50 flex items-center justify-center text-2xl font-bold text-emerald-600 mx-auto mb-4">
              {user.name.charAt(0)}
            </div>
            ...
            <Badge className="mt-3 bg-emerald-100 text-emerald-700 border-emerald-200 hover:bg-emerald-100">Active</Badge>
          </CardContent>
        </Card>
