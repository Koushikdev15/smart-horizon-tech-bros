...
const statusConfig: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  'Completed':     { bg: 'bg-primary/10 dark:bg-primary/16', text: 'text-primary dark:text-primary', dot: 'bg-primary' },
  ...
  'Verified':      { bg: 'bg-primary/10 dark:bg-primary/16', text: 'text-primary dark:text-primary', dot: 'bg-primary' },
  'Active':        { bg: 'bg-primary/10 dark:bg-primary/16', text: 'text-primary dark:text-primary', dot: 'bg-primary' },
  ...
  'Resolved':      { bg: 'bg-primary/10 dark:bg-primary/16', text: 'text-primary dark:text-primary', dot: 'bg-primary' },
  'Closed':        { bg: 'bg-gray-100   dark:bg-gray-800',       text: 'text-gray-500   dark:text-gray-400',    dot: 'bg-gray-400'    },
  'Released':      { bg: 'bg-primary/10 dark:bg-primary/16', text: 'text-primary dark:text-primary', dot: 'bg-primary' },
  ...
  'Ready':         { bg: 'bg-primary/10 dark:bg-primary/16', text: 'text-primary dark:text-primary', dot: 'bg-primary' },
