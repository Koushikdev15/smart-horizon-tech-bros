...
const myPayments = mockPayments.filter(p => p.stage === 'Manufacturing' || p.recipientRole === 'Manufacturer');
...
export default function Payments() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <PageHeader title="Payments" description="Track your earnings from certified batch manufacturing" />
