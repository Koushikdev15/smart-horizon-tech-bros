...
const rejected = mockBatches.filter(b => b.status === 'Rejected' && b.currentStage === 'Supply Chain');
...
export default function RejectedBatches() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <PageHeader title="Rejected Batches" description="Shipments quarantined due to transit or delivery failures" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <StatsCard title="Rejection Rate" value="1.9%" icon={XCircle} iconColor="text-red-600" iconBg="bg-red-50 dark:bg-red-950/40" />
      </div>
